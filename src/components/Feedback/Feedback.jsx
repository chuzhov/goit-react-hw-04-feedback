  ...
  render() {
    return (
      <section className={css['feedback']}>
        ...
        <h1>Statistics</h1>
        <p>
          Good:<span className={css['stat-counter']}>{this.state.good}</span>
        </p>
        <p>
          Neutral:
          <span className={css['stat-counter']}>{this.state.neutral}</span>
        </p>
        <p>
          Bad:<span className={css['stat-counter']}>{this.state.bad}</span>
        </p>
      </section>
    );
  }
